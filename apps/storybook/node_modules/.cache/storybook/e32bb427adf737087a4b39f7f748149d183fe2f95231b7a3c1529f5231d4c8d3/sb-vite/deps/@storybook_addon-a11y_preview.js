...
// ../../node_modules/.pnpm/@storybook+addon-a11y@8.6.15_storybook@8.6.15/node_modules/@storybook/addon-a11y/dist/preview.mjs
...
var run = async (input = defaultParameters) => {
  let { default: axe } = await import("./axe-GOC5XNYJ.js"), { element = "body", config = {}, options = {} } = input, htmlElement = document.querySelector(element) ?? document.body;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-ALD7IVHT.js");
